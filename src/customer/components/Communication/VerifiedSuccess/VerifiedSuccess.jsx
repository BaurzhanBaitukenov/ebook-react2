...
import { verifiedAccountAction } from '../../../../State/Payment/Action';
        ...
        <div className=" space-y-10 p-10 ">
          <div className='flex flex-col items-center justify-center'>
            <img
              ...
              alt=""
            />
            {auth.user?.req_user != null || false ? (
              <Alert className='my-5 font-bold text-3xl' severity="success">
                Congratulations Your Account Is Verified
              </Alert>
            ) : (
              <Alert className='my-5 font-bold text-3xl' severity="warning">
          ...
          <div>
            ...
            <Button className="rounded-full my-5" sx={{ width: "100%", borderRadius: "25px", padding: "12px 0px" }} onClick={() => navigate(`/communication/profile/${auth.user.id}`)} variant='contained'>Go To Profile</Button>
          </div>
        </div>
