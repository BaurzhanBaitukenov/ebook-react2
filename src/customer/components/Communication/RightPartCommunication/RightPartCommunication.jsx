    ...
    return (
        <div className='py-5 sticky top '>
            ...
            <section className='mt-7 space-y-5'>
                ...
                <div>
                    <p className='text-sm'> NEW BOOK FROM BEST AUTHOR
                    </p>
                    <p className='font-bold'>Harry Potter new part</p>
                </div>

                {[1,1,1].map((item) => <div className='flex justify-between w-full'>
                    <div>
                        <p>Entertainment . Trending . Comics</p>
                        <p className='font-bold'>#TheMarvelsComics</p>
                        <p>34.3k Tweets</p>
                    </div>
                    <MoreHorizIcon />
                </div>)}
