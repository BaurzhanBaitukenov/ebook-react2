                    ...
                    <div className='flex justify-center py-10'>
                        <div className='w-[80%] space-y-10'>
                            <div className='p-5 rounded-md flex items-center justify-between shadow-lg'>
                                <h1 className='text-xl pr-5'>Blue Subscription with a verified phone number will get a blue checkmark once approved.</h1>
                                <img className='w-24 h-24' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRAQX6gij6C9gCJMxLjDiUXpOMM35-pEJ2DkQ&usqp=CAU" alt="" />
                            </div>
                            ...
                            <div className='cursor-pointer flex justify-center bg-gray-900 text-white rounded-full px-5 py-3'>
                                <span className='line-through italic'>₸1000</span>
                                <span className='px-5'>₸850/year</span>
                            </div>
                        </div>
                    </div>
                </Box>
