...
import { makePaymentAction } from '../../../../State/Payment/Action';
          ...
          <Box sx={style}>
            ...
            <div className="flex justify-center py-10">
              <div className="w-[80%] space-y-10 hideScrollbar overflow-y-scroll  overflow-x-hidden ">
                <div className="p-5  rounded-md flex items-center justify-between bg-gray-300 shadow-lg">
                ...
                <div onClick={makePayment} className=" cursor-pointer flex justify-center bg-white text-black rounded-full px-5 py-3">
                  <span className="line-through italic">₸1000/month</span>{" "}
                  <span className="px-5">₸2500/year</span>
                </div>
              </div>
            </div>
