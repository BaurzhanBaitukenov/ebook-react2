...
const product = {
    ...
    sizes: [
        { name: 'KZ', inStock: true },
        { name: 'RUS', inStock: true },
        { name: 'ENG', inStock: true },
        { name: 'SWISS', inStock: true }
    ],
    description:
    ...
    return (
        <div className="bg-white">
            <div className="pt-6">
                ...
                <section className='grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10 px-4 pt-10'>
                    ...
                    lg:pb-24">
                        <div className="lg:col-span-2">
                            <h1 className="text-lg lg:text-xl font-semibold text-gray-900">Harry Potter</h1>
                        ...
                        <div className="mt-4 lg:row-span-3 lg:mt-0">
                            ...
                            <div className='flex space-x-5 item-center text-lg lg:text-xl text-gray-900 mt-6'>
                                ...
                                <p className='font-semibold'>T100</p>
                                <p className='opacity-50 line-through'>T1000</p>
                            ...
                            <div className="mt-6">
                                <div className='flex items-center space-x-3'>
                                    ...
                                    <p className='opcaity-50 text-sm'>56535 Ratings</p>
                                    <p className='ml-3 text-sm font-medium text-indigo-600 
                                    hover:text-indigo-500'>3871 Reviews</p>
                                </div>
                ...
                {/* rating and reviews */}
                <section>
                    <h1 className='font-semibold text-lg pb-4 flex'>Recent Review & Rating</h1>
